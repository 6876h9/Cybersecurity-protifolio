...
The goal of this portfolio is to show how  I think about security problems, not just that I solved them.
  ...
  #WHAT THIS REPOSITORY CONTIANS
    ####Documented: Hack the Box
    ####Try hack Me and pico ctf labs
    #### Linux and Windows privilege escalation practice
    #### Vulnerability analysis and impact understanding
    #### Defenceif security, and mitigation thinking
    #### Early cloud and AI security learning
